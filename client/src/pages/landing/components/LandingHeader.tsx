      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link to="/signup" className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:shadow-md transition duration-300">
              Sign Up
            </Link>
          </div>
        ...
        <div className="lg:hidden bg-white shadow-lg p-4 mt-3">
          <nav className="flex flex-col space-y-4">
            ...
            <div className="pt-4 mt-2 border-t border-gray-100 flex flex-col space-y-3">
              <Link to="/signin" className="px-4 py-2 text-center border border-gray-300 rounded-lg text-gray-700">
                Log In
              </Link>
              <Link to="/signup" className="px-4 py-2 text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg">
                Sign Up
              </Link>
            </div>
          </nav>
