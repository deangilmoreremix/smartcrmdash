...
import { startPerformanceTracking } from '../../utils/performanceMetrics';
import { 
  Brain, 
  Sparkles, 
  User, 
...
export const InteractiveContactScorer: React.FC = () => {
  const [perfMetrics] = useState(() => startPerformanceTracking('InteractiveContactScorer'));
  ...
  const calculateScore = () => {
    setIsScoring(true);
    const { endInteraction } = perfMetrics.trackInteraction();
