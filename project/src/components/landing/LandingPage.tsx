...
export const LandingPage: React.FC<LandingPageProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[var(--blue-50)] via-white to-[var(--purple-50)] z-50 overflow-y-auto">
      {/* Header */}
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-[var(--gray-200)]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-gradient-to-br from-[var(--primary-500)] to-[var(--primary-600)] rounded-xl flex items-center justify-center">
                <span className="text-white font-bold text-[var(--text-lg)]">S</span>
              </div>
              <div>
                <h1 className="text-[var(--text-2xl)] font-bold text-[var(--gray-900)]">Smart CRM Dashboard</h1>
                <p className="text-[var(--gray-600)]">AI-Powered Customer Relationship Management</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={onClose}
                className="p-[var(--space-2)] text-[var(--gray-400)] hover:text-[var(--gray-600)] hover:bg-[var(--gray-100)] rounded-lg transition-colors"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center mb-16">
          <h2 className="text-[var(--text-5xl)] font-bold text-[var(--gray-900)] mb-[var(--space-6)] hero-title">
            The Future of
            <span className="bg-gradient-to-r from-[var(--primary-600)] to-[var(--primary-600)] bg-clip-text text-transparent"> AI-Powered </span>
            CRM
          </h2>
          <p className="text-[var(--text-xl)] text-[var(--gray-600)] max-w-3xl mx-auto mb-[var(--space-8)] hero-description">
          ...
          <div className="flex items-center justify-center space-x-4 hero-cta">
            <ModernButton
              variant="primary"
              size="lg"
              onClick={onClose}
              className="flex items-center space-x-2 bg-gradient-to-r from-[var(--primary-600)] to-[var(--primary-600)] button-hover button-active"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => {
              ...
              return (
                <GlassCard
                  key={feature.id}
                  className="p-6 feature-card cursor-pointer group"
                ...
                >
                  ...
                  <div className="relative mb-6 overflow-hidden rounded-lg">
                    <img
                      src={feature.image}
                      alt={feature.title}
                      className="w-full h-48 object-cover feature-card-image"
                    />
